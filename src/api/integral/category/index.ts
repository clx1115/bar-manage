...
export function getCategoryList(params?: object) {
  return request({
    url: '/v1/shop/shop_category/score_product_categories/',
    method: 'get',
    params: params,
  })
}
...
export function getCategoryDetail(data: any) {
  return request({
    url: `/v1/shop/shop_category/score_product_categories/${data.id}/`,
    method: 'get',
...
export function addCategory(data: object) {
  return request({
    url: '/v1/shop/shop_category/score_product_categories/new/',
    method: 'post',
    data,
  })
}
