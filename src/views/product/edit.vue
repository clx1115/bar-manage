    ...
    <el-card shadow="hover" class="layout-padding-auto">
      <el-tabs v-model="activeName">
        ...
        <!-- <el-tab-pane label="分销设置" name="distribution">
          <product-distribution ref="distributionRef" :detailData="detailData" />
        </el-tab-pane> -->
      </el-tabs>
      <div class="bottom">
...
import productDistribution from './component/productDistribution.vue'
...
const getDetailData = () => {
  ...
  getProductDetail({
    ...
    state.detailData = {
      ...
      price: (res.price || res.minPrice || 0) / 100
    }
