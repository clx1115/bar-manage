  ...
  <div class="page-container layout-padding">
    <el-card shadow="hover" class="layout-padding-auto">
      ...
      <el-tabs type="border-card" class="mt20">
        ...
        <el-tab-pane label="当前寄存">
          <placeList :uid="uid" />
        </el-tab-pane>
        <el-tab-pane label="寄存明细">
          <placeLog :uid="uid" />
        </el-tab-pane>
...
import rechargeLog from './component/rechargeLog.vue'
import recordLog from './component/recordLog.vue'
import placeList from './component/placeList.vue'
import placeLog from './component/placeLog.vue'
import balanceLog from './component/balanceLog.vue'
