<template>
  <div class="dialog-container">
    <el-dialog title="选择文章" v-model="isShowDialog" width="80%" :close-on-click-modal="false" :destroy-on-close="true">
      <el-form class="query" :inline="true">
        <el-form-item>
          <el-input v-model="queryData.filter" size="default" placeholder="请输入关键字"> </el-input>
        </el-form-item>
        <el-form-item>
          <el-select size="default" v-model="queryData.categoryId" placeholder="请选择文章分类" clearable>
      ...
      <el-table :data="list" v-loading="loading" style="width: 100%" @selection-change="selectedList = $event">
        ...
        <el-table-column prop="categoryName" label="文章分类" show-overflow-tooltip width="150" />
