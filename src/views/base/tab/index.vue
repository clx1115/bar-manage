  ...
  <div class="page-container layout-padding">
    <el-card shadow="hover" class="layout-padding-auto">
      ...
      <el-table :data="list" v-loading="loading" style="width: 100%">
        ...
        <el-table-column prop="tabName" label="Tab名称" width="150"></el-table-column>
        <el-table-column prop="headPic" label="首图" show-overflow-tooltip>
...
import { getTabList, delTab } from '@/api/base/tab/index'
// 引入组件
