        ...
        <el-row :gutter="35">
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
            <el-form-item label="选择分类" prop="category">
              <el-select v-model="ruleForm.category" placeholder="请选择分类" style="width: 240px">
                <el-option v-for="i in categoryList" :label="i.name" :value="i.id" :key="i.id" />
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
            <el-form-item label="毛利率" prop="rate">
              <el-input v-model="ruleForm.rate" clearable style="width: 240px">
