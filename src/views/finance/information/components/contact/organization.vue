<template>
  ...
  <el-button class="mb20">导出</el-button>
  <el-table :data="list" v-loading="loading" style="width: 100%" :header-cell-style="{ background: '#f5f7fa' }">
    <el-table-column prop="code" label="组织名称" width="150" show-overflow-tooltip />
    <el-table-column prop="name" label="店铺编号" width="150" show-overflow-tooltip />
    <el-table-column prop="itemTypeName" label="经营模式" min-width="150" show-overflow-tooltip />
