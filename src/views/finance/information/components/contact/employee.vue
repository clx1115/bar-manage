<template>
  ...
  <el-table :data="list" v-loading="loading" style="width: 100%" :header-cell-style="{ background: '#f5f7fa' }">
    <el-table-column prop="code" label="账号" width="150" show-overflow-tooltip />
    ...
    <el-table-column prop="itemTypeName" label="所属组织/员工角色" min-width="150" show-overflow-tooltip />
