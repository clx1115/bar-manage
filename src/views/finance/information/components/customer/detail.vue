<template>
  <div class="dialog-container">
    <el-dialog :title="dialog.title" v-model="dialog.isShowDialog" width="600px" :close-on-click-modal="false" :destroy-on-close="true">
      <el-form ref="dialogFormRef" :model="ruleForm" :rules="rules" size="default" label-width="140px">
        <el-row :gutter="35">
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
            <el-form-item label="费用项目编码" prop="code">
              <el-input v-model="ruleForm.code" placeholder="请输入费用项目编码" clearable style="width: 320px"></el-input>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
            <el-form-item label="费用项目名称" prop="name">
              <el-input v-model="ruleForm.name" placeholder="请输入费用项目名称" clearable style="width: 320px"></el-input>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
            <el-form-item label="费用分类" prop="category">
              <el-select v-model="ruleForm.category" placeholder="请选择费用分类" style="width: 320px">
                <el-option v-for="i in categoryList" :label="i.name" :value="i.id" :key="i.id" />
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
            <el-form-item label="备注" prop="remark">
              <el-input v-model="ruleForm.remark" placeholder="请输入备注" type="textarea" clearable style="width: 320px"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
const { loading, ruleForm, rules, categoryList, dialog } =
  toRefs(state)
...
const openDialog = (type: string, row: any) => {
  ...
  if (type === 'edit') {
    state.dialog.title = '修改费用项目'
    state.dialog.submitTxt = '修 改'
  } else {
    state.dialog.title = '新建费用项目'
