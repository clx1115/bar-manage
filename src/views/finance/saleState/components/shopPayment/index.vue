<template>
  ...
  <el-table :data="list" v-loading="loading" style="width: 100%" @selection-change="handleSelectionChange" :header-cell-style="{ background: '#f5f7fa' }">
    ...
    <el-table-column prop="code" label="收款日期" width="150" show-overflow-tooltip />
    ...
    <el-table-column prop="itemTypeName" label="优惠金额(元)" min-width="150" show-overflow-tooltip />
    <el-table-column prop="itemTypeName" label="应收金额(元)" min-width="150" show-overflow-tooltip />
    <el-table-column prop="itemTypeName" label="实收金额(元)" min-width="150" show-overflow-tooltip />
    <el-table-column prop="itemTypeName" label="收款差异(元)" min-width="150" show-overflow-tooltip />
