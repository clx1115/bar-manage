  ...
  <div class="page-container layout-padding">
    <el-card shadow="hover" class="layout-padding-auto">
      <el-form class="query" :inline="true">
        <el-form-item>
          <el-radio-group v-model="queryData.status" size="default" @change="getListData">
            ...
            <el-radio-button :label="2">已转账</el-radio-button>
            <el-radio-button :label="-1">已拒绝</el-radio-button>
          </el-radio-group>
        </el-form-item>
        <el-form-item>
          <el-input v-model="queryData.uid" size="default" placeholder="请输入用户ID" clearable style="width: 160px"> </el-input>
        </el-form-item>
        <el-form-item>
      ...
      <el-table :data="list" v-loading="loading" style="width: 100%">
        ...
        <el-table-column prop="phoneNumber" label="用户手机" width="150"></el-table-column>
        ...
        <el-table-column label="实提金额" width="100">
          <template #default="{ row }">
            {{ parseMoney(row.realAmount) }}
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作人">
          <template #default="{ row }">
            <span v-if="row.operatorId > 0">{{ row.operatorName }}({{ row.operatorId }})</span>
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作" width="100">
          <template #default="{ row }">
            <el-form>
              ...
              <el-button v-if="row.status === 10 || row.status === 1" size="small" text type="primary" @click="onOpenDetail('audit', row)">处理</el-button>
            </el-form>
          </template>
        </el-table-column>
      </el-table>
...
import { getWithdrawList } from '@/api/finance/withdraw/index'
