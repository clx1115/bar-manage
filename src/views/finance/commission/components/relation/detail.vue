      ...
      <el-form ref="dialogFormRef" :model="ruleForm" :rules="rules" size="default" label-width="100px">
        <el-row :gutter="35">
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
            <el-form-item label="销售单元" prop="participants">
              <el-select v-model="ruleForm.dateType" filterable>
                <el-option label="xxx" :value="10" />
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
            <el-form-item label="上级邀请单元" prop="participants">
              <el-select v-model="ruleForm.dateType" filterable>
                <el-option label="xxx" :value="10" />
              </el-select>
            </el-form-item>
...
const openDialog = (type: string, row: any) => {
  ...
  if (type === 'edit') {
    state.dialog.title = '修改销售单元'
    state.dialog.submitTxt = '修 改'
  } else {
    state.dialog.title = '添加销售单元'
