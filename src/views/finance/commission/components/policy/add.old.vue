    ...
    <el-form ref="dialogFormRef" :model="ruleForm" :rules="rules" size="default" label-width="240px">
      <div class="card">
        ...
        <div class="form-item-list">
          ...
          <el-form-item v-if="type == 2 || type == 3 || type == 4 || type == 5 || type == 8" label="网点业绩归属优先级：" prop="priority">
            <div>
          ...
          <el-form-item v-if="type == 2 || type == 3 || type == 4 || type == 5 || type == 6 || type == 7 || type == 8" label="计算时点：">
            履约完成
          </el-form-item>
      ...
      <template v-if="type == 2 || type == 3">
        <div class="card">
          <h2 class="title">销售收款条款</h2>
          <div class="line"></div>
          <div class="form-item-list">
            <el-form-item label="订单储值支付是否需要回款：" prop="needRefund1">
              <el-radio-group v-model="ruleForm.needRefund1">
                <el-radio :label="true">是</el-radio>
                <el-radio :label="false">否</el-radio>
              </el-radio-group>
            </el-form-item>
            <el-form-item label="" style="margin-top: -14px;">
              <p>若选择了是，则订单中储值支付的金额，将由总部回款到业绩归属单元。</p>
            </el-form-item>
            <div style="margin-left: 210px;" v-if="ruleForm.needRefund1">
              <el-form-item label="储值支付赠送金店铺承担比例：" prop="proportion1">
                <el-input v-model="ruleForm.proportion1" style="width: 200px">
                  <template #append>%</template>
                </el-input>
              </el-form-item>
              <el-form-item label="储值回款费用店铺承担比例：" prop="proportion2">
                <el-input v-model="ruleForm.proportion1" style="width: 200px">
                  <template #append>%</template>
                </el-input>
              </el-form-item>
            </div>
            <el-form-item label="订单非储值支付是否需要回款：" prop="needRefund2">
              <el-radio-group v-model="ruleForm.needRefund2">
                <el-radio :label="true">是</el-radio>
                <el-radio :label="false">否</el-radio>
              </el-radio-group>
            </el-form-item>
            <el-form-item label="" style="margin-top: -14px;">
              <p>若选择了是，则订单中非储值支付的金额也将按照业绩归属，由总部回款到业绩归属单元。</p>
            </el-form-item>
            <div style="margin-left: 180px;" v-if="ruleForm.needRefund2">
              <el-form-item label="交易服务费是否参与回款：" prop="needRefund3">
                <el-radio-group v-model="ruleForm.needRefund3">
                  <el-radio :label="true">是</el-radio>
                  <el-radio :label="false">否</el-radio>
                </el-radio-group>
              </el-form-item>
              ...
              <div style="margin-left: 240px;" v-if="ruleForm.needRefund3">
                <el-form-item label="交易服务器分摊比例（业绩单元）：" prop="proportion3">
                  <el-input v-model="ruleForm.proportion3" style="width: 200px">
                    <template #append>%</template>
                  </el-input>
                </el-form-item>
                <el-form-item label="交易服务器分摊比例（总部）：" prop="proportion4">
                  <el-input v-model="ruleForm.proportion4" style="width: 200px">
                    <template #append>%</template>
                  </el-input>
                </el-form-item>
              </div>
      ...
      <template v-if="type == 4 || type == 5 || type == 6 || type == 7 || type == 8">
        <div class="card">
          ...
          <div class="form-item-list">
            ...
            <template v-else>
              <el-form-item label="剔除支付类型：" style="width: 600px;">
                <div>
                  <el-checkbox label="现金" v-model="ruleForm.deductionRule1" />
                  <el-checkbox label="标记支付" v-model="ruleForm.deductionRule2" />
                </div>
              </el-form-item>
            </template>
      ...
      <template v-if="type == 2 || type == 3 || type == 4 || type == 5 || type == 6 || type == 7 || type == 8">
        <div class="card">
          ...
          <div class="form-item-list">
            ...
            <el-form-item label="结算账户：">
              <el-radio-group v-model="ruleForm.accountType">
                ...
                <el-radio :label="2" v-if="type == 2">收益账户</el-radio>
              </el-radio-group>
            </el-form-item>
