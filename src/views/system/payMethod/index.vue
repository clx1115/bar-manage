  ...
  <div class="page-container layout-padding">
    <el-card shadow="hover" class="layout-padding-auto">
      <el-form class="query" :inline="true">
        ...
        <el-form-item>
          <el-button size="default" type="success" class="ml10" @click="onClone">
            <el-icon>
              <ele-Refresh />
            </el-icon>
            同步系统支付方式
      ...
      <el-table :data="list" v-loading="loading" style="width: 100%">
        ...
        <el-table-column label="操作" width="100">
          <template #default="{ row }">
            <el-button v-if="row.orgId > 0" size="small" text type="primary" @click="onOpenEdit('edit', row)">修改</el-button>
            <el-button v-if="row.orgId > 0" size="small" text type="primary" @click="onRowDel(row)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-card>
...
import { getPayMethodList, delPayMethod, clonePayMethod } from '@/api/system/payMethod/index'
// 引入组件
