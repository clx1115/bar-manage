      ...
      <el-table :data="list" v-loading="loading" style="width: 100%">
        ...
        <el-table-column prop="groupName" label="角色">
          <template #default="{ row }">
            <el-tag type="success" v-if="row.rules === 'admin'">管理员</el-tag>
            <el-tag type="success" v-if="row.rules === 'director'">店长</el-tag>
            <el-tag type="success" v-if="row.rules === 'finance'">财务</el-tag>
            <el-tag type="success" v-if="row.rules === 'cashier'">收银</el-tag>
            <el-tag type="success" v-if="row.rules === 'warehouse'">仓管</el-tag>
            <el-tag type="success" v-if="row.rules === 'vouching'">核单员</el-tag>
            <el-tag type="success" v-if="row.rules === 'driver'">司机</el-tag>
          </template>
        </el-table-column>
        <el-table-column prop="shopName" label="绑定店铺" show-overflow-tooltip></el-table-column>
